...
const FinalCTA = () => {
    return (
        <section className="bg-white px-5 py-16 sm:px-8 lg:py-24">
            <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-linear-to-br from-brand-600 to-brand-800 px-6 py-14 text-center shadow-2xl shadow-brand-900/20 sm:px-12 lg:py-20">
                ...
                <div className="relative">
                    ...
                    <h2 className="mx-auto mt-5 max-w-3xl text-3xl font-bold leading-tight tracking-tight text-white sm:text-4xl lg:text-5xl">
                        Pronto para ter o seu Certificado Digital A1?
                    </h2>
